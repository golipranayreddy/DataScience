...
def Monthly_Scrape(symbol):
    driver = webdriver.Chrome("C:\Windows\chromedriver.exe")
    url = "https://query1.finance.yahoo.com/v7/finance/download/"+symbol+"?period1=1451692800&period2=1609545600&interval=1mo&events=history&includeAdjustedClose=true"
    driver.get(url)
    time.sleep(2)
